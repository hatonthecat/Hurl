...
An example of postmodernist cinema might be the modern adaptation of the 1995 movie [Romeo and Juliet](https://en.wikipedia.org/wiki/Romeo_%2B_Juliet) by Baz Luhrmann. An example of Rebaudrillization might be a remake of [Alice in Wonderland](https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Alice-in-Wonderland_by-David-Revoy_2010-07-21.jpg/2048px-Alice-in-Wonderland_by-David-Revoy_2010-07-21.jpg) to a more innocent (and less dark) remake, but set in a modern era, despite the 19th century original setting. Each generation shapes the story, but storytelling is sometimes timeless, and that which is meaningless is not necessarily tied to a single generation. 
